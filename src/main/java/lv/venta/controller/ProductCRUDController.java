...
public class ProductCRUDController {
	...
	public String getProductCRUDUpdateById(@PathVariable(name = "id") int id, Model model) {
		try {
	...
	public String getProductCRUDDeleteById(@PathVariable(name = "id") int id, Model model) {
